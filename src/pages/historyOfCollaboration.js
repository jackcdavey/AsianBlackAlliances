                  ...
                  <Paper elevation={3}  className="collabTag" sx={{borderRadius: '25px !important'}}>
                    ...
                    {tag.link.map((link) => (
                      <Button
                        ...
                        key={tag.link.indexOf(link)}
                        sx={{ m: 1, borderRadius: "25px", maxHeight: '25%' }}>
                ...
                <TimelineContent>
                  <Paper elevation={3} className="collabTag" sx={{borderRadius: '25px !important'}}>
                    ...
                    {tag.link.map((link) => (
                      <Button
                        key={tag.link.indexOf(link)}
                        variant="contained" href={link} target="_blank" rel="noopener noreferrer" sx={{ m: 1, borderRadius: "25px", maxHeight: '25%' }}>
                        {/* if there is a link label display, otherwise "More Info" */}
                        {tag.linkLabel[tag.link.indexOf(link)] ? tag.linkLabel[tag.link.indexOf(link)] : "More Info"}

...
<a href='#food' className='collapsed-desc'>
                ...
                <div style={{display: 'flex', flexDirection: 'column', paddingLeft: '1rem', alignItems: 'center', textAlign: "center"}}> 
                      ...
                      {chef?.links && (
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginTop: '1rem', width: '100%' }}>
                          ...
                          <a href={chef?.links[index]} target="_blank" key={index}>
            ...
            {fashion2L.map((fashion) => (
              ...
              {/* for each link, create a button */}
                ...
                // Display a button for each link
                  ...
                  <Button
                    key={fashion?.link.indexOf(link)}
                    variant="contained" color="primary" href={fashion?.link[fashion?.link.indexOf(link)]} target="_blank" rel="noopener noreferrer" sx={{ display: 'flex', width: "90%", textAlign: 'center', margin: '2%', borderRadius: '25px' }} >
      ...
      <div style={{ gridColumn: "span 2", backgroundColor: 'lightblue', borderRadius: '25px'}}>
        <div style={styles.seasonQuad}>
          <div className='holidayTextL'>
              ...
              holiday.season === 'winter' || holiday.season === '冬季 ' || holiday.season === '겨울 ' || holiday.season === 'Mùa đông ' || holiday.season === '冬季' || holiday.season == '冬 ' ?
                      <div
                        key={holiday._id}
      ...
      <div style={{gridColumn: "span 2", backgroundColor: 'lightgreen', borderRadius: '25px' }}>
        <div style={styles.seasonQuad}>
          <div className='holidayTextR'>
                  ...
                  {holidayL.map((holiday) => (
              holiday.season === 'spring' || holiday.season === '春季 ' || holiday.season === '봄 ' || holiday.season == 'Mùa xuân ' || holiday.season === '春季' || holiday.season === '春 ' ?
                      <div
                        key={holiday._id}
                        style={{ paddingBottom: "10%", lineHeight: '1.3rem' }}>
                <h3 style={{marginBottom: '0px', marginTop: '0px'}}>{holiday?.title}</h3>
      ...
      <div style={{gridColumn: "span 2", backgroundColor: 'lightyellow', borderRadius: '25px' }}>
        <div style={styles.seasonQuad}>
          <div className='holidayTextL'>
                  ...
                  {holidayL.map((holiday) => (
              holiday.season === 'summer' || holiday.season === '夏季 ' || holiday.season === '여름 ' || holiday.season === 'Mùa hè ' || holiday.season === '夏季' || holiday.season === '夏' ?
                      <div
                        key={holiday._id}
                        style={{ paddingBottom: "10%", lineHeight: '1.3rem' }}>
                <h3 style={{marginBottom: '0px', marginTop: '0px'}}>{holiday?.title}</h3>
      ...
      <div style={{gridColumn: "span 2", backgroundColor: 'lightsalmon', borderRadius: '25px' }}>
        <div style={styles.seasonQuad}>
                  ...
                  {holidayL.map((holiday) => (
              holiday.season === 'fall'|| holiday.season === '秋天 ' || holiday.season === '가을 ' || holiday.season == 'Mùa thu ' || holiday.season === '秋天' || holiday.season === '秋 ' ?
                      <div
                        key={holiday._id}
                        style={{ paddingBottom: "10%", lineHeight: '1.3rem' }}>
                <h3 style={{marginBottom: '0px', marginTop: '0px'}}>{holiday?.title}</h3>
